...
structure (`MolStructure`); the DEPTH LOOP stays as a pressure-continuation warm-start strategy
...
md(r"""The `nequa` rows are the algebraic equations NMOLEC solves: equation 0 is the ideal-gas total-particle/pressure closure, the middle rows conserve the nuclei of each element that appears in any molecule, and the last row enforces charge balance.""")
