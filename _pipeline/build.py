...
Most lecture notebooks are assembled by _pipeline/build_lecture<N>_gpu.py, while a small
number of remaining boundary lectures still use non-torch builders. This script executes
the assembled notebooks and renders the HTML fragment. Device selection happens inside the
notebooks that use torch.

  python _pipeline/build_lecture2_gpu.py  # assemble content/Lecture2.ipynb
