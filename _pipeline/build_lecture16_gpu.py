...
code(r'''pa = EOS.popsall(T, P, xabund, tab=TAB, wtmole=wtmole)
...
code(r'''ei1, ei2, ei3, ei4, r1, r2, r3, r4 = EOS.convec_fd_raw(T, P, xabund, wtmole, pa.xne, TAB)
...
code(r'''xnfpmol, dop_mol, mol_nelion = MF.molecular_deposit_populations(T, P, pa, xabund, vturb, REF / "molecules.dat")
