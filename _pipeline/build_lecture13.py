...
With these in hand, nothing in a cool-star synthesis is borrowed. The molecular populations come from the coupled solver, the molecular bands from Lecture 12's Voigt engine, and the molecular continuum from Part 2 — all on the same H$^-$ continuum (Lecture 3), atomic-line (Lectures 4–6), and radiative-transfer (Lectures 7–8) machinery as the warm-star pipeline. This completes Part V's microphysics. Next, **Lecture 14** assembles every component built so far — the equation of state, the continuum, the atomic and hydrogen and helium lines, these molecular bands and continuum, and the JOSH transfer — into one lean synthesiser and runs the **emergent spectrum end to end** across four stars spanning the HR diagram. That closes the *synthesis* half of the book; the *atmosphere* half is then carried to its real, line-blanketed finish in **Part VI**.""")
