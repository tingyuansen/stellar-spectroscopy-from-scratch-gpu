...
- Dense pedagogical code cells remain in L8, L13, and L14 under the current
...
- Remaining long-cell audit using the stricter `>=100` line threshold:
  L8 has 2, L13 has 1, and L14 has 9. L1-L7, L9-L12, and L15-L16 have no code cells at or above
  this threshold.
